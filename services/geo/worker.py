...
def process_geo_job(self, job_id: str, idempotency_key: str, payload: dict):
    ...
    try:
        ...
        # We explicitly delegate to the P3 pipeline if present. If not, we complete the P4 boundary logic safely.  # noqa: E501
        try:
            ...
            logger.warning(
                "P3 ML packages not yet implemented. GeoJob executing strictly the P4 raster preparation phase."  # noqa: E501
            )
