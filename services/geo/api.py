...
if TITILER_AVAILABLE:
    ...
    def fallback_tiles():
        raise HTTPException(status_code=501, detail="titiler.core missing from environment. Tiles unavailable.")
...
def submit_geo_job_api(
    ...
    logger.info(f"AUDIT: org={org_id} action=submit_geo_job job_id={actual_job_id} trace_id={trace_id}")
