...
geo_search_latency_ms = Histogram(
    ...
    'Latency of geospatial metadata searches'
)

geo_job_duration_ms = Histogram(
    'geo_job_duration_ms',
    'Duration of asynchronous geospatial jobs'
)

asset_download_failure_total = Counter(
    'asset_download_failure_total',
    'Total number of failed asset downloads'
)

raster_validation_failure_total = Counter(
    'raster_validation_failure_total',
    'Total number of raster validation failures'
)
