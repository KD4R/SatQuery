...
class SearchService:
    ...
    def _generate_cache_key(self, provider_name: str, polygon: Dict, start: datetime, end: datetime, **kwargs) -> str:
        payload = {
    ...
    def search_observations(
        ...
        **kwargs
        ...
        cache_key = self._generate_cache_key(provider_name, polygon, start_date, end_date, cloud_cover=cloud_cover, **kwargs)
        ...
        if provider_name == "bhoonidhi":
            ...
            raw_items = self.planetary_computer.search(polygon, start_date, end_date, cloud_cover, **kwargs)
        else:
