    ...
    <>
      ...
      <aside className="drawer">
        ...
        <div className="trace-intro">
          ...
          <span>Correlation IDs preserved across the mission path.</span>
        </div>
        <div className="trace">
          {stages.map((s) => (
        ...
        <div className="trace-note">
          <Clock3 size={13} />
          <span>
            Trace fields: trace_id · mission_id · run_id · job_id ·
