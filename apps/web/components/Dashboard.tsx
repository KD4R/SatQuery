...
const EvidenceGraphDrawer = dynamic(() => import('./evidence/EvidenceGraphDrawer'), { ssr: false });
...
export default function Dashboard(){
  ...
  const graph = useMemo(() => {
    return buildEvidenceGraph(agentState);
  }, [agentState]);
