...
const HELD_OUT = REGIONS.filter((r) => r.split === "held-out").map((r) => r.name);
      ...
      <div className="sq-hero-copy">
        ...
        <Rise delay={0.55}>
          <p className="sq-lede">
            ...
            cloud that floods arrive with — and returns the evidence, the caveats, and what
      ...
      >
        <figcaption className="sq-figure-caption">
          ...
          <div className="sq-figure-sub">
            <span>Sen1Floods11 · {HELD_OUT.join(", ")} held out of training</span>
        ...
        >
          ...
          <div className="sq-validation-id">
            <span className="sq-validation-name">{HEADLINE.model.toUpperCase()}</span>
          ...
          <div className="sq-validation-grid">
            <div className="sq-metric">
              ...
              <span className="sq-metric-note">pooled · baseline {f3(HEADLINE.baselinePooledIoU)}</span>
            </div>
            <div className="sq-metric">
              <span className="sq-metric-k">Held-out F1</span>
              <span className="sq-metric-v">{f3(HEADLINE.pooledF1)}</span>
              <span className="sq-metric-note">pooled · baseline {f3(HEADLINE.baselinePooledF1)}</span>
            </div>
            <div className="sq-metric">
            ...
            <div className="sq-metric">
              ...
              <span className="sq-metric-note">chips · {TRAINED_REGIONS} regions</span>
            </div>
          </div>
        </motion.aside>
      </motion.figure>
